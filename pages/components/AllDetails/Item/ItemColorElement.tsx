...
const ItemColorElement = (props:any) => {
  return (
    <>
      <div className="px-2 md:py-2">
        <div
          className="relative w-[30px] h-[30px] md:w-[40px] md:h-[40px] rounded-full mx-auto cursor-pointer" 
...
export default ItemColorElement